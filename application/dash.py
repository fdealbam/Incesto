...
#---------Grafica mensual
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("Jalisco", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Los 10 municipios con más incesto fueron: Guadalajara (24), Zapopan (19), Puerto Vallarta (6),"
                              " Tonalá (6), Tlajomulco de Zúñiga (5), Ameca (1), Cuquío (1), Arandas (1), Colotlán (1) y El Salto (1).",
               ...
               dbc.Col(dbc.Button(([html.P("Hidalgo", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/hdg.jpeg?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Los 10 municipios con más incesto fueron: Mineral de la Reforma (43), Pachuca de Soto (1), "
                           "Huejutla de Reyes (1), Acatlán (0), Santiago Tulantepec de Lugo Guerrero (0), Tepehuacán de Guerrero (0)"
                           ", Tepeapulco (0), Tenango de Doria (0), Tecozautla (0) y Tasquillo (0).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
    ...
    html.Br(),
          ...
          dbc.Col(dbc.Button(([html.P("Guanajuato", style={"font-size": 30,"color": "black","background-color": "white"}),
                       ...
                       html.P(
                           "Los 10 municipios con más incesto fueron: Irapuato (2), Pénjamo (1), San Felipe (1), Celaya (1),"
                           " León (1), Jerécuaro (1), Jaral del Progreso (1), Cortazar (1), Santa Catarina (0)"
                           " y San Diego de la Unión (0).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '300px',
