...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/Incesto/main/Incesto2015_2021.csv")
...
TOTINCESTO = delitoso['Grand total'].sum()
pobtot = junto15_21['Totpob1521'].sum()
TASAINCESTO = round((TOTINCESTO/pobtot)*100000,0)
...
bulletedo1 = ("Los 10 municipios con más delitos de incesto fueron: "+str(n1edo1)  +" ("+ str(v1edo1)+"), "+str(n2edo1) +" ("+ str(v2edo1)+"), "+str(n3edo1) +" ("+ str(v3edo1)+"), "+str(n4edo1) +" ("+ str(v4edo1)+"), "+str(n5edo1) +" ("+ str(v5edo1)+"), "+str(n6edo1) +" ("+ str(v6edo1)+"), "+str(n7edo1) +" ("+ str(v7edo1)+"), "+str(n8edo1) +" ("+ str(v8edo1)+"), "+str(n9edo1) +" ("+ str(v9edo1) +") y "+str(n10edo1)+" ("+ str(v10edo1)+").")
bulletedo2 = ("Los 10 municipios con más delitos de incesto fueron: "+str(n1edo2) +" ("+ str(v1edo2)+"), "+str(n2edo2) +" ("+ str(v2edo2)+"), "+str(n3edo2) +" ("+ str(v3edo2)+"), "+str(n4edo2) +" ("+ str(v4edo2)+"), "+str(n5edo2) +" ("+ str(v5edo2)+"), "+str(n6edo2) +" ("+ str(v6edo2)+"), "+str(n7edo2) +" ("+ str(v7edo2)+"), "+str(n8edo2) +" ("+ str(v8edo2)+"), "+str(n9edo2) +" ("+ str(v9edo2)+") y "+str(n10edo2) +" ("+ str(v10edo2)+").")
bulletedo3 = ("Los 10 municipios con más delitos de incesto fueron: "+str(n1edo3) +" ("+ str(v1edo3)+"), "+str(n2edo3) +" ("+ str(v2edo3)+"), "+str(n3edo3) +" ("+ str(v3edo3)+"), "+str(n4edo3) +" ("+ str(v4edo3)+"), "+str(n5edo3) +" ("+ str(v5edo3)+"), "+str(n6edo3) +" ("+ str(v6edo3)+"), "+str(n7edo3) +" ("+ str(v7edo3)+"), "+str(n8edo3) +" ("+ str(v8edo3)+"), "+str(n9edo3) +" ("+ str(v9edo3)+") y "+str(n10edo3) +" ("+ str(v10edo3)+").")
bulletedo4 = ("Los 10 municipios con más delitos de incesto fueron: "+str(n1edo4) +" ("+ str(v1edo4)+"), "+str(n2edo4) +" ("+ str(v2edo4)+"), "+str(n3edo4) +" ("+ str(v3edo4)+"), "+str(n4edo4) +" ("+ str(v4edo4)+"), "+str(n5edo4) +" ("+ str(v5edo4)+"), "+str(n6edo4) +" ("+ str(v6edo4)+") y "+str(n7edo4) +" ("+ str(v7edo4)+"). ")#+str(n8edo4) +" ("+ str(v8edo4)+"), "+str(n9edo4) +" ("+ str(v9edo4)+") y "+str(n10edo4) +" ("+ str(v10edo4)+").")
            ...
            [
                ...
                html.P(
                    ...
                    "agenda legislativa, pero hoy alcanzan relevancia en la agenda seguridad pública del país, también. "
                      " Entre 2015 y 2022 se registraron "+ str(f"{int(TOTINCESTO):,}") +" casos, lo que representa una tasa de "+
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de incesto" ),
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.H5("2015", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2015.png?raw=true",
               ...
               dbc.Col(dbc.Button(([html.H5("2016", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2016.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2017", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2017.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2018", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2018.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2019", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2019.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2020", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2020.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2021", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2021.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2022", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa%20incesto%20Total2022.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
...
#---------Grafica mensual
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P(edoname1, style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa Hidalgo.png?raw=true",
                  style={'size': 2,}),
                          html.P(bulletedo1,
               ...
               dbc.Col(dbc.Button(([html.P(edoname2, style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa Jalisco.png?raw=true",
                                    style={'size': 2,}),
                       html.P(bulletedo2,
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
    ...
    html.Br(),
               ...
               dbc.Col(dbc.Button(([html.P(edoname3, style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa Guanajuato.png?raw=true"),
                     html.Br(),
                                     html.Br(),
                                     html.Br(),
          ...
          dbc.Col(dbc.Button(([html.P(edoname4, style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Incesto/blob/main/application/static/Mapa Baja California.png?raw=true"),
    ...
    #[
        dbc.Row([
                ...
                html.P(
                    ...
                    "Como se indica en cada caso, la información sobre el delito incesto "
